...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/train/exp17/weights/best.pt',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='./birds/test', help='source')  # file/folder, 0 for webcam
