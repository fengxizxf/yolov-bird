...
class UI_Logic_Window(QtWidgets.QMainWindow):
    ...
    def model_init(self):
        ...
        parser.add_argument('--source', type=str,
                            default='100birds/tests/', help='source')
        parser.add_argument('--img-size', type=int,
                            default=224, help='inference size (pixels)')
    ...
    def button_image_open(self):
        ...
        name_list = []
        img_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "打开图片", "100birds/tests/", "*.jpg;;*.png;;All Files(*)")
        # 判断图片是否为空
        if not img_name:
            ...
            file_path = 'output/img_output/' + new_filename
    ...
    def set_video_name_and_path(self):
            ...
            # 视频检测结果存储位置
            save_path = 'output/video_output/' + now + '.mp4'
            return fps, w, h, save_path

    # 打开视频并检测
    def button_video_open(self):
        print('button_video_open')
        video_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "打开视频", "100birds/video/", "*.mp4;;*.avi;;All Files(*)")
