...
if __name__ == '__main__':
    ...
    parser.add_argument('-ap', '--anno-path', type=str, default='./data1/labels/yolo', help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default='./data1/convert/voc', help='xml save path')
    parser.add_argument('--image-path', default='./data1/images')
    ...
    if len(sys.argv) > 1:
        ...
        anno_path = './data1/labels/yolo'
        save_path = './data1/VOC2007/Annotations'
        image_path = './data1/VOC2007/JPEGImages'
